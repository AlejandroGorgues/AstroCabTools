...
class Ui_all_tools(object):
    ...
    def retranslateUi(self, all_tools):
        ...
        self.label_3.setText(_translate("all_tools", "Tool that visualize the relationship between emitted wavelength and density flux associate."))
        ...
        self.label_5.setText(_translate("all_tools", "Tool that visualize multiple gauss fitted models based on an spectrum."))
        self.fitLineButton.setText(_translate("all_tools", "fit_line"))
        self.label_6.setText(_translate("all_tools", "Tool that visualize cubes given a MIRI cube format"))
