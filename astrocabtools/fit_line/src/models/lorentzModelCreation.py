...
from  astrocabtools.fit_line.src.utils.fitting_model_creation import calculate_intercept, calculate_slope, integrated_flux, lorentzian_fitting_function, line_fitting_function, quadratic_fitting_function
...
class lorentzModel:
    ...
    def draw_model_fit(self, path, wavelength, flux):
        ...
        if self.__typeCont == 'line':
            inital_y_values = self._generate_initial_lorentz_model(wavelengthValues, self.__lorentzDict['top'][1] - (self.__lorentzDict['left'][1] + self.__lorentzDict['right'][1])/2.,
                self.__lorentzDict['top'][0], abs(self.__lorentzDict['sigma2'][0]-self.__lorentzDict['sigma1'][0])/2.)

            line = Model(line_fitting_function, name = 'continuum_fitting_function')

            lorentz_model = lorentz + line
            slope = calculate_slope(self.__lorentzDict['left'][0], self.__lorentzDict['left'][1],self.__lorentzDict['right'][0], self.__lorentzDict['right'][1])

            params = lorentz_model.make_params(h = self.__lorentzDict['top'][1] - (self.__lorentzDict['left'][1] + self.__lorentzDict['right'][1])/2.,
                                             c = self.__lorentzDict['top'][0],
                                             sigma=abs(self.__lorentzDict['sigma2'][0]-self.__lorentzDict['sigma1'][0])/2.,
                                             a=calculate_intercept(slope, self.__lorentzDict['left'][0], self.__lorentzDict['left'][1]),
                                             b=slope)
            ...
            inital_y_values = self._generate_initial_lorentz_model(wavelengthValues, self.__lorentzDict['top'][1] - (self.__lorentzDict['left'][1] + self.__lorentzDict['right'][1])/2.,
                self.__lorentzDict['top'][0], abs(self.__lorentzDict['sigma2'][0]-self.__lorentzDict['sigma1'][0])/2.355)
