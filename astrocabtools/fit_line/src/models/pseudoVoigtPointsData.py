...
"""
__all__ = ['pseudoVoigtPointsData']

class pseudoVoigtPointsData:

    def __init__(self, leftX, rightX, topX, sigma1X, sigma2X, leftY, rightY, topY, sigma1Y,sigma2Y, fraction):
        self.__leftX = leftX
    ...
    def asdict(self, prefix=''):
        return {'left': (self.__leftX, self.__leftY), 'right':(self.__rightX, self.__rightY),prefix+'sigma1': (self.__sigma1X, self.__sigma1Y), prefix+'sigma2': (self.__sigma2X, self.__sigma2Y),prefix+"top":(self.__topX, self.__topY), prefix+"fraction":self.__fraction}
