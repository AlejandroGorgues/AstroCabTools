...
class Ui_cubeLoader(object):
    ...
    def retranslateUi(self, cubeLoader):
        ...
        self.subbandComboBox.setItemText(0, _translate("cubeLoader", "1A"))
        self.subbandComboBox.setItemText(1, _translate("cubeLoader", "1B"))
        self.subbandComboBox.setItemText(2, _translate("cubeLoader", "1C"))
        self.subbandComboBox.setItemText(3, _translate("cubeLoader", "2A"))
        self.subbandComboBox.setItemText(4, _translate("cubeLoader", "2B"))
        self.subbandComboBox.setItemText(5, _translate("cubeLoader", "2C"))
        self.subbandComboBox.setItemText(6, _translate("cubeLoader", "3A"))
        self.subbandComboBox.setItemText(7, _translate("cubeLoader", "3B"))
        self.subbandComboBox.setItemText(8, _translate("cubeLoader", "3C"))
        self.subbandComboBox.setItemText(9, _translate("cubeLoader", "4A"))
        self.subbandComboBox.setItemText(10, _translate("cubeLoader", "4B"))
        self.subbandComboBox.setItemText(11, _translate("cubeLoader", "4C"))
