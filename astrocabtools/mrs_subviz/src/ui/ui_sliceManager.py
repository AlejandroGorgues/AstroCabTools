...
class Ui_sliceManager(object):
    ...
    def retranslateUi(self, sliceManager):
        ...
        self.subbandSelectionComboBox.setItemText(1, _translate("sliceManager", "1A"))
        self.subbandSelectionComboBox.setItemText(2, _translate("sliceManager", "1B"))
        self.subbandSelectionComboBox.setItemText(3, _translate("sliceManager", "1C"))
        self.subbandSelectionComboBox.setItemText(4, _translate("sliceManager", "2A"))
        self.subbandSelectionComboBox.setItemText(5, _translate("sliceManager", "2B"))
        self.subbandSelectionComboBox.setItemText(6, _translate("sliceManager", "2C"))
        self.subbandSelectionComboBox.setItemText(7, _translate("sliceManager", "3A"))
        self.subbandSelectionComboBox.setItemText(8, _translate("sliceManager", "3B"))
        self.subbandSelectionComboBox.setItemText(9, _translate("sliceManager", "3C"))
        self.subbandSelectionComboBox.setItemText(10, _translate("sliceManager", "4A"))
        self.subbandSelectionComboBox.setItemText(11, _translate("sliceManager", "4B"))
        self.subbandSelectionComboBox.setItemText(12, _translate("sliceManager", "4C"))
