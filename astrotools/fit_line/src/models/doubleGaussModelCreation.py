...
from  astrotools.fit_line.src.utils.fitting_model_creation import calculate_intercept, calculate_slope, integrated_flux, double_curve_fitting, gauss_fitting_function
