...
import astrotools.fit_line.src.viewers.spectrumSelection as stmS
import astrotools.fit_line.src.viewers.gaussDataVisualization as gaussS
import astrotools.fit_line.src.ui.ui_fit_line
...
class MrsFitLine(QMainWindow, astrotools.fit_line.src.ui.ui_fit_line.Ui_FitLine):
