...
import astrotools.fit_line.src.viewers.gaussDataCreatedListWidget as gausslw
import astrotools.fit_line.src.viewers.residualsVisualization as ressV
import astrotools.fit_line.src.ui.ui_gaussDataVisualization


class MrsFitLineData(QDialog, astrotools.fit_line.src.ui.ui_gaussDataVisualization.Ui_gaussDataVisualization):
