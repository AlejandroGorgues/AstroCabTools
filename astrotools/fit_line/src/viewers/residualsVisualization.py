...
import astrotools.fit_line.src.ui.ui_residualsVisualization

class MrsResidualsV(QDialog, astrotools.fit_line.src.ui.ui_residualsVisualization.Ui_residualsVisualization):
