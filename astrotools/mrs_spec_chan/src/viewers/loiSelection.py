...
import astrotools.mrs_spec_chan.src.viewers.lineOfInterestSelectionListWidget as loiw

from ..utils.constants import LOID

import astrotools.mrs_spec_chan.src.ui.ui_loi_selection


class MrsLoiList(QDialog, astrotools.mrs_spec_chan.src.ui.ui_loi_selection.Ui_MrsLoiList):
