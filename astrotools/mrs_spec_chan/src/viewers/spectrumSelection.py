...
import astrotools.mrs_spec_chan.src.viewers.spectrumSelectionListWidget as pltw

import astrotools.mrs_spec_chan.src.ui.ui_spectrum_selection

from ..utils.fileDialogProxyModel import ProxyModel


class MrsSpctrmList(QDialog, astrotools.mrs_spec_chan.src.ui.ui_spectrum_selection.Ui_MrsSpctrmList):
