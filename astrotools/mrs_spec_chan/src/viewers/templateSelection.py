...
import astrotools.mrs_spec_chan.src.ui.ui_template_selection


class MrsTmpltList(QDialog, astrotools.mrs_spec_chan.src.ui.ui_template_selection.Ui_MrsTmpltList):
