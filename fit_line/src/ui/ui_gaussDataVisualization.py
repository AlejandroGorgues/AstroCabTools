...
class Ui_gaussDataVisualization(object):
    def setupUi(self, gaussDataVisualization):
        ...
        self.gridLayout.addWidget(self.gaussListWidget, 1, 0, 1, 1)
        ...
        self.residualsButton = QtWidgets.QPushButton(gaussDataVisualization)
        self.residualsButton.setEnabled(False)
        self.residualsButton.setFocusPolicy(QtCore.Qt.ClickFocus)
        self.residualsButton.setObjectName("residualsButton")
        self.gridLayout.addWidget(self.residualsButton, 0, 0, 1, 1)
    ...
    def retranslateUi(self, gaussDataVisualization):
        ...
        self.residualsButton.setText(_translate("gaussDataVisualization", "Show residuals"))
